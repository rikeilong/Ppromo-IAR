...
def extract_feats(params, model, load_image_fn):
    ...
    for video in video_list:
        ...
        if os.path.exists(outfile1):
            ...
            ### image
            select_img = []
            image_list = sorted(glob.glob(os.path.join(params['video_path'], dst, '*.jpeg')))
            ...
            image_list = frame_indices[::1]  # 1 fps
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", dest='output_dir', type=str, default="/mnt/sda/smarthome_res18_14x14", 
                        help='directory to store features')
    parser.add_argument("--n_frame_steps", dest='n_frame_steps', type=int, default=480,
                        help='how many frames to sampler per video')
    parser.add_argument("--video_path", dest='video_path', type=str, default="/home/qilang/PythonProjects/ICME/frames/", 
